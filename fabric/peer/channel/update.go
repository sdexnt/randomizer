...
func update(cmd *cobra.Command, args []string, cf *ChannelCmdFactory) error {
	...
	// begin test nasa
	logger.Info("begin update channel config")
	...
	// begin test nasa
	logger.Info("begin unmarshal envelop from fileData")
	fmt.Println("begin unmarshal envelop from fileData")
	...
	// begin test nasa
	logger.Info("begin sanityCheckAndSignConfigTx")
	fmt.Println("begin sanityCheckAndSignConfigTx")
	...
	// begin test nasa
	logger.Info("send envelop from broadcastClient")
	fmt.Println("send envelop from broadcastClient")
